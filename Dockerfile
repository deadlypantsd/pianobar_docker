...
RUN	 pacman -Syu --noconfirm alsa-lib alsa-utils curl libshout pianobar pulseaudio nano screen vlc git binutils fakeroot make autoconf automake gcc debugedit
